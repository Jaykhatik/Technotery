...
Neon DB (PostgreSQL) in a new Next.js project, in the exact order to run them.
...
# with postgresql initialization
...
Get this string from your [Neon Dashboard](https://console.neon.tech) →
